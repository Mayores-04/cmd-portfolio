        ...
        return (
          <li key={s.name} className="flex items-center">
            ...
            >
              ...
              <Icon
                size={18}
                className="mr-2 text-term-text group-hover:text-term-cyan transition-colors duration-150"
              />

              {/* TEXT */}
              <span className="text-term-text group-hover:text-term-cyan transition-colors duration-150">
                {s.display}
              </span>
              ...
              <FiExternalLink
                size={14}
                className="ml-2 text-term-text opacity-70 group-hover:text-term-cyan transition-colors duration-150"
              />
            </a>
          </li>
        );
