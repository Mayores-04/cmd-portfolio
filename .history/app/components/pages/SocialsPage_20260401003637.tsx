        ...
        return (
          <li key={s.name} className="flex items-center group">
            <a
              ...
              className="flex items-center hover:underline transition-colors duration-150"
            >
              <Icon
                size={18}
              ...
              />
              <span className="transition-colors duration-150 text-term-text group-hover:text-term-cyan group-focus:text-term-cyan group-active:text-term-cyan">
                {s.display}
              </span>
              <FiExternalLink
                size={14}
