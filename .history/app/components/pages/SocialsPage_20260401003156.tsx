        ...
        return (
          <li key={s.name} className="flex items-center group">
            ...
            <a
              ...
              className="text-term-text group-hover:text-term-cyan group-focus:text-term-cyan group-active:text-term-cyan hover:underline focus:underline transition-colors duration-150"
            >
              {s.display}
            </a>
            <FiExternalLink
