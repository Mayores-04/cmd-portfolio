...
const quickCommands = [
  ...
  "3 | cat journey.md         # Achievements, milestones, and growth",
  "4 | cat contact.txt        # Contact channels and quick links",
  "5 | cat socials.txt        # Social media profiles",
  "6                          # Resume summary and download link",
  "cd about|projects|journey|contact|socials|resume  # Navigate to a section",
